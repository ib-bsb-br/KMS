...
function infraMenuSistemaEsquema(bolInicializar, tipo, dirImagens){
  ...
  if (dirImagens == undefined){
    dirImagens = '/infra_css/imagens';
  }
  ...
  if (imgMenu==null){
   ...
   if (title=='Exibir'){
     imgMenu.src = dirImagens + '/botao_menu_abrir.gif';
   }else{
     imgMenu.src = dirImagens + '/botao_menu_fechar.gif';
   }
  }
}
