...
class InfraString {
	...
	private static $arrMinusculas               = array("a",        "a",        "a",        "a",     "a",       "e",        "e",        "e",      "e",       "i",        "i",      "o",        "o",       "o",       "o",      "u",        "u",      "c");
	private static $arrMaiusculas               = array("A",        "A",        "A",        "A",     "A",       "E",        "E",        "E",      "E",       "I",        "I",      "O",        "O",       "O",       "O",      "U",        "U",      "C");
	private static $arrMinusculasAcentuadas     = array("á",        "ã",        "à",        "ä",     "â",       "é",        "è",        "ë",      "ê",       "í",        "ï",      "ó",        "õ",       "ô",       "ö",      "ú",        "ü",      "ç");
	private static $arrMaiusculasAcentuadas     = array("Á",        "Ã",        "À",        "Ä",     "Â",       "É",        "È",        "Ë",      "Ê",       "Í",        "Ï",      "Ó",        "Õ",       "Ô",       "Ö",      "Ú" ,       "Ü",      "Ç");
	private static $arrMinusculasAcentuadasHTML = array("&aacute;", "&atilde;", "&agrave;", "&auml;","&acirc;", "&eacute;", "&egrave;", "&euml;", "&ecirc;", "&iacute;", "&iuml;", "&oacute;", "&otilde;","&ocirc;", "&ouml;", "&uacute;", "&uuml;", "&ccedil;");
	private static $arrMaiusculasAcentuadasHTML = array("&Aacute;", "&Atilde;", "&Agrave;", "&Auml;","&Acirc;", "&Eacute;", "&Egrave;", "&Euml;", "&Ecirc;", "&Iacute;", "&Iuml;", "&Oacute;", "&Otilde;","&Ocirc;", "&Ouml;", "&Uacute;", "&Uuml;", "&Ccedil;");
 ...
 public static function formatarNome($strNome){
  ...
  public static function abreviarDestacarTexto($texto, $substring, $tamanhoMax, $htmlDestaqueIni, $htmlDestaqueFim, $maxTrechos = 3){
    ...
    if (strlen($texto) <= $tamanhoMax){
      ...
      $numSubstr = count($arrPosDestaque);
