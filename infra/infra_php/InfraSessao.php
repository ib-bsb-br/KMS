...
abstract class InfraSessao {
  ...
  private function gerarObjInfraSessaoDTO($obj){
		...
		$objInfraSessaoDTO->setStrDnUsuario($obj->strDnUsuario);
    ...
    if (InfraDebug::isBolProcessar()) {
      ...
      InfraDebug::getInstance()->gravarInfra('DN do Usuário: ' . $objInfraSessaoDTO->getStrDnUsuario());
  ...
  public function getStrDnUsuario(){
    if (($objInfraSessaoDTO = $this->getObjInfraSessaoDTO())!=null){
      return $objInfraSessaoDTO->getStrDnUsuario();
    }
    return null;
  }
