...
class InfraException extends Exception {
  ...
  public function __construct($strDescricao=null, Exception $e=null, $strDetalhes=null, $bolPermitirGravacaoLog=null, $strStaTipoLog = null) {
	...
	public function lancarValidacao($strDescricao, $strAtributo=null, Exception $e=null){
    if ( $this->arrObjInfraValidacao != null ){
  ...
  public function isBolPermitirGravacaoLog() {
	...
	public function __toString() {
	    ...
	    } else if ( $this->strDescricao != null ) {
	      $str = $this->strDescricao;
	...
	public static function inspecionar(Exception $e){
