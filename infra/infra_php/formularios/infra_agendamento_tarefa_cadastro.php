...
try {
  ...
  $strHelp = 'Como preencher do complemento da periodicidade:<br /><br />';
  $strHelp .= 'Tarefas diárias: informe a hora de execução sem zeros à esquerda.<br /><br />';
  $strHelp .= 'Tarefas semanais: informe o dia da semana (1-segunda, 2-terça, 3-quarta, 4-quinta, 5-sexta, 6-sábado, 7-domingo) e a hora de execução.<br /><br />';
  $strHelp .= 'Tarefas mensais: informe o dia do mês (1 a 31) e a hora de execução.<br /><br />';
  $strHelp .= 'Tarefas anuais: informe o dia do mês (1 a 31), o mês (1 a 12) e a hora de execução.<br /><br />';
  $strHelp .= 'Múltiplas execuções devem ser separadas por vírgula sem espaço entre os argumentos.<br /><br />';
  $strHelp .= 'Exemplos:<br /><br />';
  $strHelp .= 'Diários: 0,6,12,18,... ou simplesmente 22<br /><br />';
  $strHelp .= 'Semanais: 1/0,3/22,... ou simplesmente 7/0<br /><br />';
  $strHelp .= 'Mensais: 10/0,20/12,... ou simplesmente 15/6<br /><br />';
  $strHelp .= 'Anuais: 10/1/0,20/6/12,... ou simplesmente 15/12/6<br /><br />';
