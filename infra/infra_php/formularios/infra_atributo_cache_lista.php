...
try {
  ...
  if ($numRegistros > 0){
    ...
    foreach($arrAtributos as $nome){
      ...
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoInfra::getInstance()->assinarLink('controlador.php?acao=infra_atributo_cache_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&nome='.$nome).'" tabindex="'.PaginaInfra::getInstance()->getProxTabTabela().'"><img src="'.PaginaInfra::getInstance()->getDiretorioImagensGlobal().'/consultar.gif" title="Consultar Atributo de Memória" alt="Consultar Atributo de Memória" class="infraImg" /></a>&nbsp;';
      }
      ...
      if ($bolAcaoExcluir){
        $strResultado .= '<a href="'.PaginaInfra::getInstance()->montarAncora($strId).'" onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaInfra::getInstance()->getProxTabTabela().'"><img src="'.PaginaInfra::getInstance()->getDiretorioImagensGlobal().'/excluir.gif" title="Excluir Atributo de Memória" alt="Excluir Atributo de Memória" class="infraImg" /></a>&nbsp;';
      }
