...
?>
  ...
  <img id="imgCalAcesso" title="Selecionar Data/Hora" alt="Selecionar Data/Hora" src="<?=PaginaInfra::getInstance()->getDiretorioImagensGlobal()?>/calendario.gif" class="infraImg" onclick="infraCalendario('txtAcesso',this);" />
