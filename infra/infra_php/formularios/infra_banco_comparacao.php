...
try {
  ...
  $numRegistros = count($arrObjInfraComparacaoBancoDTO_Tabela);
  ...
  $numRegistros = count($arrObjInfraComparacaoBancoDTO_Constraint);
  ...
  $numRegistros = count($arrObjInfraComparacaoBancoDTO_Indice);
  ...
  if ($objInfraComparacaoBancoDTO->getStrSinComparaMaxIdTabela()=='S'){
    $numRegistros = count($arrObjInfraComparacaoBancoDTO_Sequencia);
