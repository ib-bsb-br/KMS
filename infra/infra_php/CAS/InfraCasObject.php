        ...
        try {
            ...
            switch($operation) {
                case CASTOR_OPER_READ:
                    $http_arguments=$this->initArguments($http, $url, $this->uuid, "GET");
                    break;
                ...
                case CASTOR_OPER_INFO:
                    $http_arguments=$this->initArguments($http, $url, $this->uuid, "HEAD");
                    break;
                case CASTOR_OPER_DELETE:
                    $http_arguments=$this->initArguments($http, $url, $this->uuid, "DELETE");
                    break;
            }
