    ...
    if ($_GET['acao']=='regra_auditoria_reativar'){
      ...
      if ($bolCheck){
			...
			*/				
			...
			if ($bolAcaoConsultar){
				$strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=regra_auditoria_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_auditoria='.$arrObjRegraAuditoriaDTO[$i]->getNumIdRegraAuditoria()).'" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/consultar.gif" title="Consultar Regra de Auditoria" alt="Consultar Regra de Auditoria" class="infraImg" /></a>&nbsp;';
			}

			if ($bolAcaoAlterar){
				$strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=regra_auditoria_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_auditoria='.$arrObjRegraAuditoriaDTO[$i]->getNumIdRegraAuditoria()).'" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/alterar.gif" title="Alterar Regra de Auditoria" alt="Alterar Regra de Auditoria" class="infraImg" /></a>&nbsp;';
			}
        ...
        $strDescricao = $arrObjRegraAuditoriaDTO[$i]->getStrDescricao();
			...
			if ($bolAcaoDesativar && $arrObjRegraAuditoriaDTO[$i]->getStrSinAtivo()=='S'){
				$strResultado .= '<a onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/desativar.gif" title="Desativar Regra de Auditoria" alt="Desativar Regra de Auditoria" class="infraImg" /></a>&nbsp;';
			}

			if ($bolAcaoReativar && $arrObjRegraAuditoriaDTO[$i]->getStrSinAtivo()=='N'){
				$strResultado .= '<a onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/reativar.gif" title="Reativar Regra de Auditoria" alt="Reativar Regra de Auditoria" class="infraImg" /></a>&nbsp;';
			}
			
			if ($bolAcaoExcluir){
				$strResultado .= '<a onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/excluir.gif" title="Excluir Regra de Auditoria" alt="Excluir Regra de Auditoria" class="infraImg" /></a>&nbsp;';
			}
