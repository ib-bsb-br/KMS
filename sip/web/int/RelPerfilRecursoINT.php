...
class RelPerfilRecursoINT extends InfraINT {
  ...
  public static function montarSelectPerfisRecurso($numIdSistema, $numIdRecurso){
    ...
    return parent::montarSelectArrInfraDTO($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado,$arrObjRelPerfilRecursoDTO, 'IdPerfil', 'NomePerfil');
  }
