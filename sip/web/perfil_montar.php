      ...
      if ($bolListar){  
        ...
        PaginaSip::getInstance()->processarPaginacao($objPerfilDTO);
				...
				if ($numRegistros > 0){
					...
					$strResultado .= '<th class="infraTh" width="10%" valign="top"><div style="padding:.2em;"><div style="float:left;"><a onclick="selecaoMultiplaRecursos();" tabindex="'.PaginaSip::getInstance()->getProxTabTabela().'">&nbsp;<img src="imagens/check.gif" id="imgInfraCheckRecursos" title="Selecionar Tudo" alt="Selecionar Tudo" class="infraImg" /></a></div><div style="float:left;display:inline;padding:.2em;">&nbsp;Perfil</div></div></th>';
					$strResultado .= '<th class="infraTh" valign="top"><div style="padding:.2em;"><div style="float:left;"><a onclick="selecaoMultiplaMenus();" tabindex="'.PaginaSip::getInstance()->getProxTabTabela().'">&nbsp;<img src="imagens/check.gif" id="imgInfraCheckMenus" title="Selecionar Tudo" alt="Selecionar Tudo" class="infraImg" /></a></div><div style="float:left;display:inline;padding:.2em;">&nbsp;Menu</div></div></th>';
					$strResultado .= '</tr>'."\n";
