...
try {
  ...
  if ($numRegistros > 0){
    ...
    $strResultado .= '<th class="infraTh" width="15%">'.PaginaSip::getInstance()->getThOrdenacao($objSistemaDTO,'Sigla','Sigla',$arrObjSistemaDTO).'</th>';
    ...
    $strResultado .= '<th class="infraTh" width="10%">'.PaginaSip::getInstance()->getThOrdenacao($objSistemaDTO,'Órgão','SiglaOrgao',$arrObjSistemaDTO).'</th>';
    $strResultado .= '<th class="infraTh" width="15%">'.PaginaSip::getInstance()->getThOrdenacao($objSistemaDTO,'Hierarquia','NomeHierarquia',$arrObjSistemaDTO).'</th>';
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      $strResultado .= '<td>'.PaginaSip::tratarHTML($arrObjSistemaDTO[$i]->getStrSigla()).'</td>';
      ...
      if ($bolAcaoAdministradores){
        $strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=administrador_sistema_listar&acao_retorno=sistema_listar&id_orgao_sistema='.$arrObjSistemaDTO[$i]->getNumIdOrgao().'&id_sistema='.$arrObjSistemaDTO[$i]->getNumIdSistema()).'" tabindex="'.PaginaSip::getInstance()->getProxTabTabela().'"><img src="imagens/grupo.gif" title="Administradores do Sistema" alt="Administradores do Sistema" class="infraImg" /></a>&nbsp;';
      }
      
      if ($bolAcaoClonar){
        $strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=sistema_clonar&acao_retorno=sistema_listar&id_orgao_sistema_origem='.$arrObjSistemaDTO[$i]->getNumIdOrgao().'&id_sistema_origem='.$arrObjSistemaDTO[$i]->getNumIdSistema()).'" tabindex="'.PaginaSip::getInstance()->getProxTabTabela().'"><img src="imagens/clonar.gif" title="Clonar Sistema" alt="Clonar Sistema" class="infraImg" /></a>&nbsp;';
      }
      
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=sistema_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_sistema='.$arrObjSistemaDTO[$i]->getNumIdSistema()).'" tabindex="'.PaginaSip::getInstance()->getProxTabTabela().'"><img src="imagens/consultar.gif" title="Consultar Sistema" alt="Consultar Sistema" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=sistema_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_sistema='.$arrObjSistemaDTO[$i]->getNumIdSistema()).'" tabindex="'.PaginaSip::getInstance()->getProxTabTabela().'"><img src="imagens/alterar.gif" title="Alterar Sistema" alt="Alterar Sistema" class="infraImg" /></a>&nbsp;';
      }
      ...
      if ($bolAcaoDesativar){
        $strResultado .= '<a onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabTabela().'"><img src="imagens/desativar.gif" title="Desativar Sistema" alt="Desativar Sistema" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar){
        $strResultado .= '<a onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabTabela().'"><img src="imagens/reativar.gif" title="Reativar Sistema" alt="Reativar Sistema" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoExcluir){
        $strResultado .= '<a onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabTabela().'"><img src="imagens/excluir.gif" title="Excluir Sistema" alt="Excluir Sistema" class="infraImg" /></a>&nbsp;';
      }
