...
try {
  ...
  if ($numRegistros > 0){
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoClonar){
        $strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=hierarquia_clonar&&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_hierarquia_origem='.$arrObjHierarquiaDTO[$i]->getNumIdHierarquia()).'" tabindex="'.PaginaSip::getInstance()->getProxTabTabela().'"><img src="imagens/clonar.gif" title="Clonar Hierarquia" alt="Clonar Hierarquia" class="infraImg" /></a>&nbsp;';
      }
      
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=hierarquia_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_hierarquia='.$arrObjHierarquiaDTO[$i]->getNumIdHierarquia()).'" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/consultar.gif" title="Consultar Hierarquia" alt="Consultar Hierarquia" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=hierarquia_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_hierarquia='.$arrObjHierarquiaDTO[$i]->getNumIdHierarquia()).'" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/alterar.gif" title="Alterar Hierarquia" alt="Alterar Hierarquia" class="infraImg" /></a>&nbsp;';
      }
      ...
      if ($bolAcaoDesativar){
        $strResultado .= '<a onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/desativar.gif" title="Desativar Hierarquia" alt="Desativar Hierarquia" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar){
        $strResultado .= '<a onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/reativar.gif" title="Reativar Hierarquia" alt="Reativar Hierarquia" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoExcluir){
        $strResultado .= '<a onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/excluir.gif" title="Excluir Hierarquia" alt="Excluir Hierarquia" class="infraImg" /></a>&nbsp;';
      }
