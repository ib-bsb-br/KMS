...
#txtRecurso {position:absolute;left:0%;top:6%;width:47%;border:.1em solid #666;}
#selRecursos {position:absolute;left:0%;top:14%;width:81%;}
#imgLupaRecursos {position:absolute;left:82%;top:14%;<?=$strExibirLupa?>}
#imgExcluirRecursos {position:absolute;left:82%;top:23%;<?=$strExibirLupa?>}
...
?>
  <div id="divCabecalho" class="infraAreaDados" style="height:14em;"> 
  ...
  <div id="divRecursos" class="infraAreaDados" style="height:28em;">
	  ...
	  <select id="selRecursos" name="selRecursos" size="<?=PaginaSip::getInstance()->isBolNavegadorChrome()?'14':'15'?>" multiple="multiple" class="infraSelect" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
	  <?=$strItensSelRecursos?>
	  </select>
	  <img id="imgLupaRecursos" onclick="objLupaRecursos.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Selecionar Recursos" title="Selecionar Recursos" class="infraImg" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" />	
	  <img id="imgExcluirRecursos" onclick="objLupaRecursos.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Recursos Selecionados" title="Remover Recursos Selecionados" class="infraImg" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" />
  </div>  
