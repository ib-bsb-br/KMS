      ...
      if ($bolAcaoDesativar || $bolAcaoReativar || $bolAcaoExcluir){
        ...
        $strDescricao = PaginaSip::formatarParametrosJavaScript($arrObjPerfilDTO[$i]->getStrNome());
			...
			if ($bolAcaoDesativar && !in_array($arrObjPerfilDTO[$i]->getNumIdPerfil(),$arrReservados)){
				$strResultado .= '<a onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/desativar.gif" title="Desativar Perfil" alt="Desativar Perfil" class="infraImg" /></a>&nbsp;';
			}

			if ($bolAcaoReativar){
				$strResultado .= '<a onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/reativar.gif" title="Reativar Perfil" alt="Reativar Perfil" class="infraImg" /></a>&nbsp;';
			}
			
			if ($bolAcaoExcluir && !in_array($arrObjPerfilDTO[$i]->getNumIdPerfil(),$arrReservados)){
				$strResultado .= '<a onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/excluir.gif" title="Excluir Perfil" alt="Excluir Perfil" class="infraImg" /></a>&nbsp;';
			}
