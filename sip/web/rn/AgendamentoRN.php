...
class AgendamentoRN extends InfraRN {
  ...
  public function testarAgendamento(){
    try{
      ...
      InfraMail::enviarConfigurado(ConfiguracaoSip::getInstance(), $objInfraParametro->getValor('EMAIL_SISTEMA'), $objInfraParametro->getValor('EMAIL_ADMINISTRADOR'), null, null, 'Teste Agendamento SIP', 'Agendamento SIP executado com sucesso.');
    }catch(Exception $e){
