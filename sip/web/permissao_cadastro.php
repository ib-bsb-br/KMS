...
function inicializar(){
  ...
  objAjaxUsuario.selecionar('<?=$objPermissaoDTO->getNumIdUsuario();?>','<?=PaginaSip::getInstance()->formatarParametrosJavascript($objPermissaoDTO->getStrSiglaUsuario());?>','<?=PaginaSip::getInstance()->formatarParametrosJavascript($objPermissaoDTO->getStrNomeUsuario())?>');
...
?>
  ...
  <img src="imagens/calendario.gif" id="imgCalDataInicio" title="Selecionar Data Inicial " alt="Selecionar Data Inicial" class="infraImg" onclick="infraCalendario('txtDataInicio',this);"  tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" />
  ...
  <img src="imagens/calendario.gif" id="imgCalDataFim" title="Selecionar Data Final" alt="Selecionar Data Final" class="infraImg" onclick="infraCalendario('txtDataFim',this);"  tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" />  
