...
#divSinCoordenado {position:absolute;left:0%;top:62%;}
...
PaginaSip::getInstance()->abrirAreaDados('50em');
?>
  ...
  <textarea id="txaDescricao" name="txaDescricao" class="infraTextArea" rows="10" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"><?=PaginaSip::tratarHTML($objPerfilDTO->getStrDescricao());?></textarea>
