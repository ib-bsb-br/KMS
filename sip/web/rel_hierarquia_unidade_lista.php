    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      */
      ...
      if ($bolAcaoCadastrar && $arrObjRelHierarquiaUnidadeDTO[$i]->getStrSinAtivo()=='S'){
        $strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=rel_hierarquia_unidade_cadastrar&acao_origem='.$_GET['acao'].'&id_hierarquia_superior='.$arrObjRelHierarquiaUnidadeDTO[$i]->getNumIdHierarquia().'&id_unidade_superior='.$arrObjRelHierarquiaUnidadeDTO[$i]->getNumIdUnidade()).'" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/mais.gif" title="Adicionar Subunidade" alt="Adicionar Subunidade" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar && $arrObjRelHierarquiaUnidadeDTO[$i]->getStrSinAtivo()=='S'){
        $strResultado .= '<a href="'.SessaoSip::getInstance()->assinarLink('controlador.php?acao=rel_hierarquia_unidade_alterar&acao_origem='.$_GET['acao'].'&id_hierarquia='.$arrObjRelHierarquiaUnidadeDTO[$i]->getNumIdHierarquia().'&id_unidade='.$arrObjRelHierarquiaUnidadeDTO[$i]->getNumIdUnidade()).'" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/alterar.gif" title="Alterar Unidade na Hierarquia" alt="Alterar Unidade na Hierarquia" class="infraImg" /></a>&nbsp;';
      }
      ...
      if ($bolAcaoDesativar && $arrObjRelHierarquiaUnidadeDTO[$i]->getStrSinAtivo()=='S'){
        $strResultado .= '<a onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/desativar.gif" title="Desativar Unidade na Hierarquia" alt="Desativar Unidade na Hierarquia" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar && $arrObjRelHierarquiaUnidadeDTO[$i]->getStrSinAtivo()=='N'){
        $strResultado .= '<a onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/reativar.gif" title="Reativar Unidade na Hierarquia" alt="Reativar Unidade na Hierarquia" class="infraImg" /></a>&nbsp;';
      }
      
      if ($bolAcaoExcluir /* && count($arrObjRelHierarquiaUnidadeDTO[$i]->getArrUnidadesInferiores())==0 */){
        $strResultado .= '<a onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSip::getInstance()->getProxTabDados().'"><img src="imagens/excluir.gif" title="Excluir Unidade na Hierarquia" alt="Excluir Unidade na Hierarquia" class="infraImg" /></a>&nbsp;';
      }
...
function inicializar(){
  ...
  objAjaxUnidadeRamificacao.selecionar('<?=$numIdUnidadeRamificacao;?>','<?=PaginaSip::getInstance()->formatarParametrosJavascript($strUnidadeRamificacao)?>');
