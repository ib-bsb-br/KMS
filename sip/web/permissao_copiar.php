...
#fldUnidade {position:absolute;left:40%;top:5%;height:80%;width:25%;}
#divOptMesmaUnidade {position:absolute;left:5%;top:<?=PaginaSip::getInstance()->isBolNavegadorFirefox()?'20%':'32%'?>;}
#divOptUnidadeInformada {position:absolute;left:5%;top:<?=PaginaSip::getInstance()->isBolNavegadorFirefox()?'51%':'63%'?>;}
...
function inicializar(){
  ...
  objAjaxUsuario.selecionar('<?=$numIdUsuario;?>','<?=PaginaSip::getInstance()->formatarParametrosJavascript($strSiglaUsuario);?>');
