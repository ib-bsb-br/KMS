...
#fldAcoesPadrao {position:absolute;left:0%;top:64%;height:31%;width:45%;}

#divAcaoCadastrar {position:absolute;left:7%;top:14%;width:23%;}
#divAcaoAlterar {position:absolute;left:7%;top:30%;width:23%;}
#divAcaoExcluir {position:absolute;left:7%;top:46%;width:23%;}
#divAcaoConsultar {position:absolute;left:40%;top:14%;width:23%;}
#divAcaoListar {position:absolute;left:40%;top:30%;width:23%;}
#divAcaoSelecionar {position:absolute;left:40%;top:46%;width:23%;}
#divAcaoDesativar {position:absolute;left:73%;top:14%;width:23%;}
#divAcaoReativar {position:absolute;left:73%;top:30%;width:23%;}
...
?>
  ...
  <label id="lblEntidade" for="txtEntidade" accesskey="N" class="infraLabelObrigatorio"><span class="infraTeclaAtalho">E</span>ntidade:</label>
  ...
  <fieldset id="fldAcoesPadrao">
	  <legend style="font-weight: bold;background-color:#e0e0e0;">&nbsp;Ações&nbsp;</legend>
