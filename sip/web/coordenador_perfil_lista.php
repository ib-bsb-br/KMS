...
function inicializar(){
  ...
  objAjaxUsuario.selecionar('<?=$numIdUsuario;?>','<?=$strSiglaUsuario;?>','<?=PaginaSip::getInstance()->formatarParametrosJavascript($strNomeUsuario)?>');
