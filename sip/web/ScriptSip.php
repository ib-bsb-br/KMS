...
class ScriptSip {
  ...
  public static function obterIdItemMenu($numIdSistema, $numIdMenu, $strRotulo){
    try{
  ...
  public static function adicionarItemMenu($numIdSistema, $numIdPerfil, $numIdMenu, $numIdItemMenuPai, $numIdRecurso, $strRotulo, $numSequencia ){
