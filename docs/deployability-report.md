...
- No runtime validation was executed here, but installer and verifier scripts are provided to exercise the full stack on-target.
...
2. Execute como root: `bash scripts/install-debian11-sei.sh`.
