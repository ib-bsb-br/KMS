...
#btnPesquisar {position:absolute;left:27%;top:40%;width:10%;}
...
?>
  <div id="divGeral" class="infraAreaDados" style="height:15em;">
    ...
    <select id="selProcedimentos" name="selProcedimentos" size="4" class="infraSelect" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>">
