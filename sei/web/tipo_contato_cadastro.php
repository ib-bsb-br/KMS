...
#lblUnidadesAlteracao {position:absolute;left:0%;top:38%;width:40%;}
#txtUnidadeAlteracao {position:absolute;left:0%;top:44%;width:40%;}
#selUnidadesAlteracao {position:absolute;left:0%;top:51%;width:50.5%;}
#imgLupaUnidadesAlteracao {position:absolute;left:51%;top:51%;}
#imgExcluirUnidadesAlteracao {position:absolute;left:51%;top:58%;}

#divSinPesquisaCompleta {position:absolute;left:0%;top:82%;}
#divSinPesquisaResumida {position:absolute;left:0%;top:90%;}

#divUnidadesConsulta {height:15em;}
#lblUnidadesConsulta {position:absolute;left:0%;top:0%;width:40%;}
#txtUnidadeConsulta {position:absolute;left:0%;top:12%;width:40%;}
#selUnidadesConsulta {position:absolute;left:0%;top:26%;width:50.5%;}
#imgLupaUnidadesConsulta {position:absolute;left:51%;top:26%;}
...
?>
  <form id="frmTipoContatoCadastro" method="post" onsubmit="return OnSubmitForm();" action="<?=SessaoSEI::getInstance()->assinarLink('controlador.php?acao='.$_GET['acao'].'&acao_origem='.$_GET['acao'])?>">
    ...
    <div id="divGeral" class="infraAreaDados">
      ...
      <img id="imgLupaUnidadesAlteracao" onclick="objLupaUnidadesAlteracao.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Selecionar Unidades" title="Selecionar Unidades" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
      <img id="imgExcluirUnidadesAlteracao" onclick="objLupaUnidadesAlteracao.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Unidades Selecionadas" title="Remover Unidades Selecionadas" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
    ...
    <div id="divUnidadesConsulta" class="infraAreaDados">
      ...
      <img id="imgLupaUnidadesConsulta" onclick="objLupaUnidadesConsulta.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Selecionar Unidades" title="Selecionar Unidades" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
      <img id="imgExcluirUnidadesConsulta" onclick="objLupaUnidadesConsulta.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Unidades Selecionadas" title="Remover Unidades Selecionadas" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
    </div>
    <?
