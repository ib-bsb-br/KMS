 ...
 */    }else{
    ...
    */
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=email_sistema_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_email_sistema='.$arrObjEmailSistemaDTO[$i]->getNumIdEmailSistema()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/consultar.gif" title="Consultar E-mail do Sistema" alt="Consultar E-mail do Sistema" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=email_sistema_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_email_sistema='.$arrObjEmailSistemaDTO[$i]->getNumIdEmailSistema()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/alterar.gif" title="Alterar E-mail do Sistema" alt="Alterar E-mail do Sistema" class="infraImg" /></a>&nbsp;';
      }
      ...
      if ($arrObjEmailSistemaDTO[$i]->getNumIdEmailSistema()==EmailSistemaRN::$ES_CONCESSAO_CREDENCIAL ||
        ...
        if ($bolAcaoDesativar && $arrObjEmailSistemaDTO[$i]->getStrSinAtivo()=='S'){
          $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/desativar.gif" title="Desativar E-mail do Sistema" alt="Desativar E-mail do Sistema" class="infraImg" /></a>&nbsp;';
        }
  
        if ($bolAcaoReativar && $arrObjEmailSistemaDTO[$i]->getStrSinAtivo()=='N'){
          $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/reativar.gif" title="Reativar E-mail do Sistema" alt="Reativar E-mail do Sistema" class="infraImg" /></a>&nbsp;';
        }
        
      }
      
      if ($bolAcaoExcluir){
        $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/excluir.gif" title="Excluir E-mail do Sistema" alt="Excluir E-mail do Sistema" class="infraImg" /></a>&nbsp;';
      }
