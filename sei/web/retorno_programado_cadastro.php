    ...
    case 'retorno_programado_alterar':
      ...
      if (isset($_GET['id_retorno_programado'])){
        ...
        if ($objRetornoProgramadoDTO==null){
      	...
      	$objRetornoProgramadoDTO->setStrProtocoloFormatadoAtividadeEnvio($_POST['hdnProtocoloFormatado']);
...
?>
  ...
  <input type="text" id="txtProtocoloFormatado" name="txtProtocoloFormatado" class="infraSelect" value="<?=PaginaSEI::tratarHTML($objRetornoProgramadoDTO->getStrProtocoloFormatadoAtividadeEnvio());?>" <?=$strDesabilitar?>/>
  ...
  <img id="imgCalProgramada" title="Selecionar Data Programada" alt="Selecionar Data Programada" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/calendario.gif" class="infraImg" onclick="infraCalendario('txtProgramada',this);" />
  ...
  <input type="hidden" id="hdnProtocoloFormatado" name="hdnProtocoloFormatado" value="<?=$objRetornoProgramadoDTO->getStrProtocoloFormatadoAtividadeEnvio();?>" />
  <?
