...
?>
  <div id="divGrupo" class="infraAreaDados" style="height:4.5em;">  
  ...
  <div id="divAplicabilidade" class="infraAreaDados" style="height:4.5em;">  
  ...
  <div id="divModelo" class="infraAreaDados" style="height:4.5em;">  
  ...
  <div id="divTipoFormulario" class="infraAreaDados" style="height:4.5em;">
  ...
  <div id="divNumeracao" class="infraAreaDados" style="height:4.5em;">
  ...
  <div id="divAssuntos" class="infraAreaDados" style="height:12em;">  
    ...
    <div id="divOpcoesAssuntos">
      <img id="imgLupaAssuntos" onclick="objLupaAssuntos.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Localizar Assunto" title="Localizar Assunto" class="infraImg" />
      <img id="imgAssuntosAcima" onclick="objLupaAssuntos.moverAcima();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/seta_acima_select.gif" alt="Mover Acima Assunto Selecionado" title="Mover Acima Assunto Selecionado" class="infraImg" />
      <br />
      <img id="imgExcluirAssuntos" onclick="objLupaAssuntos.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Assuntos" title="Remover Assuntos" class="infraImg" />
      <img id="imgAssuntosAbaixo" onclick="objLupaAssuntos.moverAbaixo();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/seta_abaixo_select.gif" alt="Mover Abaixo Assunto Selecionado" title="Mover Abaixo Assunto Selecionado" class="infraImg" />
    </div>
  ...
  <div id="divVeiculoPublicacao" class="infraAreaDados" style="height:12em;">  
    ...
    <div id="divOpcoesVeiculoPublicacao">
      <img id="imgLupaVeiculoPublicacao" onclick="objLupaVeiculoPublicacao.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Selecionar Veículo Publicação" title="Selecionar Veículo Publicação" class="infraImg"  />
      <br />
      <img id="imgExcluirVeiculoPublicacao" onclick="objLupaVeiculoPublicacao.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Veiculo Publicação Selecionado" title="Remover Veiculo Publicação Selecionado" class="infraImg"  />
    </div>
  </div>    
  ...
  <div id="divSinInteressado" class="infraDivCheckbox infraAreaDados" style="height:2.5em;">
    ...
    <label id="lblSinInteressado" for="chkSinInteressado" accesskey="" class="infraLabelCheckbox">Permite interessados</label>
  </div>
  ...
  <div id="divSinDestinatario" class="infraDivCheckbox infraAreaDados" style="height:2.5em;">
    ...
    <label id="lblSinDestinatario" for="chkSinDestinatario" accesskey="" class="infraLabelCheckbox">Permite destinatários</label>
  </div>
  ...
  <div id="divSinInterno" class="infraDivCheckbox infraAreaDados" style="height:2.5em;">
    ...
    <label id="lblSinInterno" for="chkSinInterno" accesskey="" class="infraLabelCheckbox">Interno do sistema</label>
  </div>
