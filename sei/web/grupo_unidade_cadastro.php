...
?>
  ...
  #txtNome {position:absolute;left:0%;top:4%;width:70.5%;}

  #lblDescricao {position:absolute;left:0%;top:11%;width:70.5%;}
  #txaDescricao {position:absolute;left:0%;top:15%;width:70.5%;}

  #lblUnidade {position:absolute;left:0%;top:29%;width:70.5%;}
  #txtUnidade {position:absolute;left:0%;top:33%;width:70.5%;}
  #selUnidades {position:absolute;left:0%;top:38%;width:81%;}
  #imgLupaUnidades {position:absolute;left:82%;top:38%;}
  #imgExcluirUnidades {position:absolute;left:82%;top:42.5%;}
...
var objAutoCompletarUnidade = null;
  ...
  <?}?>
    ...
    objAutoCompletarUnidade.selecionar('<?=$strIdUnidade?>','<?=PaginaSEI::getInstance()->formatarParametrosJavaScript($strDescricaoUnidade)?>');
