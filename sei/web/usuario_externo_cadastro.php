...
ContatoINT::montarContatoAssociado(false, null, false, null, false, null, $objUsuarioDTO->getNumIdContato(), $objUsuarioDTO->getStrSigla(), $objUsuarioDTO->getStrNome(),false,'frmUsuarioCadastro');
