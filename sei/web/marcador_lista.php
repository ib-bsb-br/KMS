  ...
  */
  ...
  if ($numRegistros > 0){
    ...
    */
    ...
    $strResultado .= '<th class="infraTh" width="10%">Ícone</th>'."\n";
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      $strResultado .= '<td align="center"><a href="#" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensLocal().'/'.$arrIcones[$arrObjMarcadorDTO[$i]->getStrStaIcone()]->getStrArquivo().'" title="'.PaginaSEI::tratarHTML($arrIcones[$arrObjMarcadorDTO[$i]->getStrStaIcone()]->getStrDescricao()).'" alt="'.PaginaSEI::tratarHTML($arrIcones[$arrObjMarcadorDTO[$i]->getStrStaIcone()]->getStrDescricao()).'" class="infraImg" /></a></td>';
      ...
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=marcador_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_marcador='.$arrObjMarcadorDTO[$i]->getNumIdMarcador()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/consultar.gif" title="Consultar Marcador" alt="Consultar Marcador" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=marcador_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_marcador='.$arrObjMarcadorDTO[$i]->getNumIdMarcador()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/alterar.gif" title="Alterar Marcador" alt="Alterar Marcador" class="infraImg" /></a>&nbsp;';
      }
      ...
      if ($bolAcaoDesativar && $arrObjMarcadorDTO[$i]->getStrSinAtivo()=='S'){
        $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/desativar.gif" title="Desativar Marcador" alt="Desativar Marcador" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar && $arrObjMarcadorDTO[$i]->getStrSinAtivo()=='N'){
        $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/reativar.gif" title="Reativar Marcador" alt="Reativar Marcador" class="infraImg" /></a>&nbsp;';
      }


      if ($bolAcaoExcluir){
        $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/excluir.gif" title="Excluir Marcador" alt="Excluir Marcador" class="infraImg" /></a>&nbsp;';
      }
