...
try {
  ...
  switch($_GET['acao']){
    ...
    case 'procedimento_escolher_tipo':
        ...
        $strImgExibir = '<img id="imgExibirTiposProcedimento" onclick="exibirTiposProcedimento(\'U\');" src="/infra_css/imagens/menos.gif" title="Exibir apenas os tipos já utilizados pela unidade" alt="Exibir apenas os tipos já utilizados pela unidade" class="infraImg" />';
