...
#lblContatos {position:absolute;left:0%;top:31%;width:50%;}
#txtContato {position:absolute;left:0%;top:36%;width:79.3%;}
#selContatos {position:absolute;left:0%;top:41.5%;width:80%;}

#imgLupaContatos {position:absolute;left:81%;top:41.5%;}
#imgExcluirContatos {position:absolute;left:81%;top:46.5%;}
...
?>
  ...
  <textarea id="txaDescricao" name="txaDescricao" rows="2" class="infraText" onkeypress="return infraLimitarTexto(this,event,250);" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><?=PaginaSEI::tratarHTML($objGrupoContatoDTO->getStrDescricao());?></textarea>
  ...
  <img id="imgLupaContatos" onclick="objLupaContatos.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Localizar Contato" title="Localizar Contato" class="infraImg" />	
  <img id="imgExcluirContatos" onclick="objLupaContatos.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Contatos" title="Remover Contato" class="infraImg" />  
