...
#divSinEstrutural {position:absolute;left:0%;top:84%;}

#divClassificacao {height:15em;<?=$strDisplayClassificacao?>}

#fldPrazos {position:absolute;left:0%;top:5%;height:80%;width:30%;}
...
?>
#lblPrazoCorrente {top:10%;}
#txtPrazoCorrente {top:27%;}

#lblPrazoIntermediario {top:50%;}
#txtPrazoIntermediario {top:67%;}

#divOptGuardaPermanente {top:25%}
#divOptDestinacao {top:60%}
<?
}
