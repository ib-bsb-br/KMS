...
?>
  ...
  <img id="imgCalFeriado" title="Selecionar Data do Feriado" alt="Selecionar Data do Feriado" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/calendario.gif" class="infraImg" onclick="infraCalendario('txtFeriado',this);" />
