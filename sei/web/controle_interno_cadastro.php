...
?>
<div id="divDados" class="infraAreaDados" style="height:55em;">
  ...
  <img id="imgLupaUnidades" onclick="objLupaUnidades.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Selecionar Unidades" title="Selecionar Unidades" class="infraImgNormal" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />	
  <img id="imgExcluirUnidades" onclick="objLupaUnidades.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Unidades Selecionadas" title="Remover Unidades Selecionadas" class="infraImgNormal" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />  
  ...
  <img id="imgLupaOrgaos" onclick="objLupaOrgaos.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Selecionar Órgãos" title="Selecionar Órgãos" class="infraImgNormal" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
  <img id="imgExcluirOrgaos" onclick="objLupaOrgaos.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Órgãos Selecionados" title="Remover Órgãos Selecionados" class="infraImgNormal" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
  ...
  <img id="imgLupaTiposProcedimento" onclick="objLupaTiposProcedimento.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Selecionar Tipos de Processo" title="Selecionar Tipos de Processo" class="infraImgNormal" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
  <img id="imgExcluirTiposProcedimento" onclick="objLupaTiposProcedimento.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Tipos de Processo Selecionados" title="Remover Tipos de Processo Selecionados" class="infraImgNormal" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
  ...
  <img id="imgLupaSeries" onclick="objLupaSeries.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Selecionar Tipos de Documento" title="Selecionar Tipos de Documento" class="infraImgNormal" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
  <img id="imgExcluirSeries" onclick="objLupaSeries.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Tipos de Documento Selecionados" title="Remover Tipos de Documento Selecionados" class="infraImgNormal" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
