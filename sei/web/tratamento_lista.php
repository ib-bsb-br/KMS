...
try {
  ...
  if ($numRegistros > 0){
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=tratamento_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_tratamento='.$arrObjTratamentoDTO[$i]->getNumIdTratamento()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/consultar.gif" title="Consultar Tratamento" alt="Consultar Tratamento" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=tratamento_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_tratamento='.$arrObjTratamentoDTO[$i]->getNumIdTratamento()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/alterar.gif" title="Alterar Tratamento" alt="Alterar Tratamento" class="infraImg" /></a>&nbsp;';
      }


      if ($bolAcaoDesativar){
        $strResultado .= '<a href="#ID-'.$arrObjTratamentoDTO[$i]->getNumIdTratamento().'"  onclick="acaoDesativar(\''.$arrObjTratamentoDTO[$i]->getNumIdTratamento().'\',\''.$arrObjTratamentoDTO[$i]->getStrExpressao().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/desativar.gif" title="Desativar Tratamento" alt="Desativar Tratamento" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar){
        $strResultado .= '<a href="#ID-'.$arrObjTratamentoDTO[$i]->getNumIdTratamento().'"  onclick="acaoReativar(\''.$arrObjTratamentoDTO[$i]->getNumIdTratamento().'\',\''.$arrObjTratamentoDTO[$i]->getStrExpressao().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/reativar.gif" title="Reativar Tratamento" alt="Reativar Tratamento" class="infraImg" /></a>&nbsp;';
      }


      if ($bolAcaoExcluir){
        $strResultado .= '<a href="#ID-'.$arrObjTratamentoDTO[$i]->getNumIdTratamento().'"  onclick="acaoExcluir(\''.$arrObjTratamentoDTO[$i]->getNumIdTratamento().'\',\''.$arrObjTratamentoDTO[$i]->getStrExpressao().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/excluir.gif" title="Excluir Tratamento" alt="Excluir Tratamento" class="infraImg" /></a>&nbsp;';
      }
