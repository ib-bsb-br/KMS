...
try {
  ...
  if ($numRegistros > 0){
    ...
    $strResultado .= '<th class="infraTh">'.PaginaSEI::getInstance()->getThOrdenacao($objCargoDTO,'Expressão','Expressao',$arrObjCargoDTO).'</th>'."\n";
    $strResultado .= '<th class="infraTh" width="25%">'.PaginaSEI::getInstance()->getThOrdenacao($objCargoDTO,'Tratamento','ExpressaoTratamento',$arrObjCargoDTO).'</th>'."\n";
    $strResultado .= '<th class="infraTh" width="25%">'.PaginaSEI::getInstance()->getThOrdenacao($objCargoDTO,'Vocativo','ExpressaoVocativo',$arrObjCargoDTO).'</th>'."\n";
    $strResultado .= '<th class="infraTh" width="10%">'.PaginaSEI::getInstance()->getThOrdenacao($objCargoDTO,'Gênero','StaGenero',$arrObjCargoDTO).'</th>'."\n";
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoDesativar){
        $strResultado .= '<a href="#ID-'.$arrObjCargoDTO[$i]->getNumIdCargo().'"  onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/desativar.gif" title="Desativar Cargo" alt="Desativar Cargo" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar){
        $strResultado .= '<a href="#ID-'.$arrObjCargoDTO[$i]->getNumIdCargo().'"  onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/reativar.gif" title="Reativar Cargo" alt="Reativar Cargo" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoExcluir){
        $strResultado .= '<a href="#ID-'.$arrObjCargoDTO[$i]->getNumIdCargo().'"  onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/excluir.gif" title="Excluir Cargo" alt="Excluir Cargo" class="infraImg" /></a>&nbsp;';
      }
