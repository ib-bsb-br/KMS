  ...
  if ($numRegistros > 0){
    ...
    for($i = 0;$i < $numRegistros; $i++){  
      ...
      if ($bolAcaoDocumentoVisualizar && $arrObjArquivamentoDTO[$i]->getNumCodigoAcesso() > 0){
      	...
      	$strResultado .= '<a href="javascript:void(0);" onclick="alert(\'Documento sigiloso.\');" class="protocoloNormal" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'" >'.PaginaSEI::tratarHTML($arrObjArquivamentoDTO[$i]->getStrProtocoloFormatadoDocumento()).'</a>';
      }  
      $strResultado .= '</td>';
      ...
      */
      ...
      if ($bolAcaoProtocoloArquivamentoReceber && ($arrObjArquivamentoDTO[$i]->getStrStaArquivamento()==ArquivamentoRN::$TA_NAO_ARQUIVADO || $arrObjArquivamentoDTO[$i]->getStrStaArquivamento()==ArquivamentoRN::$TA_DESARQUIVADO)){
      	...
      	$bolFlagNaoArquivado = true;
				...
				$strResultado .= '<a href="#ID-'.$arrObjArquivamentoDTO[$i]->getDblIdProtocolo().'"  onclick="acaoReceber(\''.$arrObjArquivamentoDTO[$i]->getDblIdProtocolo().'\',\''.$arrObjArquivamentoDTO[$i]->getStrProtocoloFormatadoDocumento().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/protocolo_receber.gif" title="Receber" alt="Receber" class="infraImg" /></a>&nbsp;';
      }
      ...
      if ($bolAcaoProtocoloArquivamentoCancelarRecebimento && 
      	...
      	$bolFlagRecebido = true;
				...
				$strResultado .= '<a href="#ID-'.$arrObjArquivamentoDTO[$i]->getDblIdProtocolo().'"  onclick="acaoCancelarRecebimento(\''.$arrObjArquivamentoDTO[$i]->getDblIdProtocolo().'\',\''.$arrObjArquivamentoDTO[$i]->getStrProtocoloFormatadoDocumento().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/protocolo_cancelar_recebimento.gif" title="Cancelar Recebimento" alt="Cancelar Recebimento" class="infraImg" /></a>&nbsp;';
      }
