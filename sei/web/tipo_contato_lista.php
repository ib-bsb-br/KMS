...
try {
  ...
  if ($numRegistros > 0){
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=tipo_contato_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_tipo_contato='.$arrObjTipoContatoDTO[$i]->getNumIdTipoContato()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/consultar.gif" title="Consultar Tipo de Contato" alt="Consultar Tipo de Contato" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=tipo_contato_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_tipo_contato='.$arrObjTipoContatoDTO[$i]->getNumIdTipoContato()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/alterar.gif" title="Alterar Tipo de Contato" alt="Alterar Tipo de Contato" class="infraImg" /></a>&nbsp;';
      }


      if ($bolAcaoDesativar){
        $strResultado .= '<a href="#ID-'.$arrObjTipoContatoDTO[$i]->getNumIdTipoContato().'"  onclick="acaoDesativar(\''.$arrObjTipoContatoDTO[$i]->getNumIdTipoContato().'\',\''.$arrObjTipoContatoDTO[$i]->getStrNome().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/desativar.gif" title="Desativar Tipo de Contato" alt="Desativar Tipo de Contato" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar){
        $strResultado .= '<a href="#ID-'.$arrObjTipoContatoDTO[$i]->getNumIdTipoContato().'"  onclick="acaoReativar(\''.$arrObjTipoContatoDTO[$i]->getNumIdTipoContato().'\',\''.$arrObjTipoContatoDTO[$i]->getStrNome().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/reativar.gif" title="Reativar Tipo de Contato" alt="Reativar Tipo de Contato" class="infraImg" /></a>&nbsp;';
      }


      if ($bolAcaoExcluir){
        $strResultado .= '<a href="#ID-'.$arrObjTipoContatoDTO[$i]->getNumIdTipoContato().'"  onclick="acaoExcluir(\''.$arrObjTipoContatoDTO[$i]->getNumIdTipoContato().'\',\''.$arrObjTipoContatoDTO[$i]->getStrNome().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/excluir.gif" title="Excluir Tipo de Contato" alt="Excluir Tipo de Contato" class="infraImg" /></a>&nbsp;';
      }
