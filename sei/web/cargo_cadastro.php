...
try {
  ...
  PaginaSEI::getInstance()->salvarCamposPost(array('selTratamento','selVocativo'));
...
#fldStaGenero {position:absolute;left:0%;top:50%;height:30%;width:21%;}
...
function novoTratamento(){
  infraAbrirJanela('<?=$strLinkNovoTratamento?>', 'janelaNovoTratamento', 700, 200, 'location=0,status=1,resizable=1,scrollbars=1');
}

function novoVocativo(){
  infraAbrirJanela('<?=$strLinkNovoVocativo?>', 'janelaNovoVocativo', 700, 200, 'location=0,status=1,resizable=1,scrollbars=1');
}
...
?>
  ...
  <img id="imgNovoTratamento" onclick="novoTratamento();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/mais.gif" alt="Novo Tratamento" title="Novo Tratamento" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"/>
  ...
  <img id="imgNovoVocativo" onclick="novoVocativo();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/mais.gif" alt="Novo Vocativo" title="Novo Vocativo" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"/>
