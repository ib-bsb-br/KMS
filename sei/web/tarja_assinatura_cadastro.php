...
?>
  ...
  <textarea id="txaTexto" name="txaTexto" rows="15"  class="infraTextarea" style="font-family: Courier, 'Courier New', monospace" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><?=InfraString::formatarXML($objTarjaAssinaturaDTO->getStrTexto());?></textarea>
  <a href="javascript:void(0);" id="ancAjuda" onclick="exibirAjuda()" title="Ajuda" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><img src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/ajuda.gif" class="infraImg"/></a>
...
?>
  ...
  <img id="imgRemover" style="<?=$strDisplayControleLogotipo?>" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/remover.gif';?>" alt="Remover Timbre" title="Remover Timbre" class="infraImg" onclick="removerTimbre();" />
</form>
<?
