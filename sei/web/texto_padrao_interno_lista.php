 ...
 */    }else{
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoExcluir){
        $strResultado .= '<a href="#ID-'.$strId.'" onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/excluir.gif" title="Excluir Texto Padrão da Unidade" alt="Excluir Texto Padrão da Unidade" class="infraImg" /></a>&nbsp;';
      }
