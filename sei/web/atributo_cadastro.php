...
?>
  ...
  <div id="divMascara" class="infraAreaDados" style="height:5em;">
    ...
    <a id="ancAjudaMascara" onclick="exibirAjudaMascara();" title="Ajuda" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><img src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/ajuda.gif" class="infraImg"/></a>
  </div>
  ...
  <div id="divData" class="infraAreaDados" style="height:16em;">
