  ...
  switch($_GET['acao']){
      ...
      if (isset($_POST['sbmSolicitar'])) {
        try{
          ...
          PaginaSEI::getInstance()->setStrMensagem('Favor entrar em contato com o arquivo para retirada '.(count($objArquivamentoDTO->getDblIdProtocolo())==1?'do documento':'dos documentos').'.',PaginaSEI::$TIPO_MSG_AVISO);
