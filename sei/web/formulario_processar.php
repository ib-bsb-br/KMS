...
try {
  ...
  switch($_GET['acao']) {
    ...
    case 'formulario_gerar':
      ...
      $arrComandos[] = '<button type="submit" accesskey="C" name="sbmFormularioProcessar" id="sbmFormularioProcessar" value="Confirmar Dados" class="infraButton"><span class="infraTeclaAtalho">C</span>onfirmar Dados</button>';
