...
?>
  ...
  <a id="ancAjudaDe" href="javascript:void(0);" onclick="exibirAjuda('<?=$strLinkAjudaRemetente?>');" title="Ajuda Remetente" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><img src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/ajuda.gif" class="infraImg"/></a>
  ...
  <a id="ancAjudaPara" href="javascript:void(0);" onclick="exibirAjuda('<?=$strLinkAjudaDestinatario?>');" title="Ajuda Destinatário" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><img src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/ajuda.gif" class="infraImg"/></a>
  ...
  <a id="ancAjudaAssunto" href="javascript:void(0);" onclick="exibirAjuda('<?=$strLinkAjudaAssunto?>');" title="Ajuda Assunto" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><img src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/ajuda.gif" class="infraImg"/></a>
  ...
  <a id="ancAjudaConteudo" href="javascript:void(0);" onclick="exibirAjuda('<?=$strLinkAjudaConteudo?>');" title="Ajuda Conteúdo" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><img src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/ajuda.gif" class="infraImg"/></a>
