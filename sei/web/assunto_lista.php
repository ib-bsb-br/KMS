  ...
  if ($numRegistros > 0){
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoDesativar && $arrObjAssuntoDTO[$i]->getStrSinAtivo()=='S'){
      	$strResultado .= '<a href="#ID-'.$arrObjAssuntoDTO[$i]->getNumIdAssunto().'"  onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/desativar.gif" title="Desativar Assunto" alt="Desativar Assunto" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar && $arrObjAssuntoDTO[$i]->getStrSinAtivo()=='N'){
        $strResultado .= '<a href="#ID-'.$arrObjAssuntoDTO[$i]->getNumIdAssunto().'"  onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/reativar.gif" title="Reativar Assunto" alt="Reativar Assunto" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoExcluir){
        $strResultado .= '<a href="#ID-'.$arrObjAssuntoDTO[$i]->getNumIdAssunto().'"  onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/excluir.gif" title="Excluir Assunto" alt="Excluir Assunto" class="infraImg" /></a>&nbsp;';
      }
