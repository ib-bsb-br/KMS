...
#selStaIcone {position:absolute;left:0%;top:4%;}

#lblNome {position:absolute;left:11%;top:0%;width:50%;}
#txtNome {position:absolute;left:11%;top:4.5%;width:50%;}
...
function inicializar(){
  ...
  <?if ($bolCadastroOk){?>
    window.opener.recarregarMarcadores('<?=$objMarcadorDTO->getNumIdMarcador()?>');
    window.close();
    return;
  <?}?>
