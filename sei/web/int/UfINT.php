...
class UfINT extends InfraINT {
  ...
  public static function montarSelectSiglaSigla($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdPais=76){
    $objUfDTO = new UfDTO();
  ...
  public static function montarSelectSiglaNome($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdPais=76){
    $objUfDTO = new UfDTO();
    $objUfDTO->retNumIdUf();
    $objUfDTO->retStrSigla();
    $objUfDTO->retStrNome();
  ...
  public static function montarSelectSiglaRI0416($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdPais=76){
    $objUfDTO = new UfDTO();
    $objUfDTO->retNumIdUf();
    $objUfDTO->retStrSigla();
    $objUfDTO->setNumIdPais($numIdPais);
