...
class CidadeINT extends InfraINT {
  ...
  public static function montarSelectIdCidadeNome($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdUf='', $numIdPais=76){
  ...
  public static function montarSelectNomeNome($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $strSiglaUf, $numIdPais=76){
    $objCidadeDTO = new CidadeDTO();
    //$objCidadeDTO->retNumIdCidade();
    $objCidadeDTO->retStrNome();
    $objCidadeDTO->setNumIdPais($numIdPais);
