...
';
  ...
  ';
    ...
    $strHtml = '
    <div id="divRestricao" class="infraAreaDados" style="height:15em;">
    ...
    <select id="selOrgaos" name="selOrgaos" size="6" class="infraSelect" onchange="trocarOrgaoRestricao()" >
    '.$strItensSelOrgaosRestricao.'
    </select>
    <div id="divOpcoesOrgaos">
      <img id="imgLupaOrgaos" onclick="objLupaOrgaos.selecionar(700,500);" src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/lupa.gif" alt="Selecionar Órgãos" title="Selecionar Órgãos" class="infraImgNormal"  />
      <br />
      <img id="imgExcluirOrgaos" onclick="objLupaOrgaos.remover();" src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/remover.gif" alt="Remover Órgãos Selecionados" title="Remover Órgãos Selecionados" class="infraImgNormal"  />
    </div>
    ...
    <div id="divOpcoesUnidades">
      <img id="imgLupaUnidades" onclick="objLupaUnidades.selecionar(700,500);" src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/lupa.gif" alt="Selecionar Unidades" title="Selecionar Unidades" class="infraImg"  />
      <br />
      <img id="imgExcluirUnidades" onclick="objLupaUnidades.remover();" src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/remover.gif" alt="Remover Unidades Selecionadas" title="Remover Unidades Selecionadas" class="infraImg"  />
    </div>
