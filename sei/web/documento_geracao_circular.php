...
try {
  ...
  if ($numRegistros > 0){
    ...
    foreach($arrObjDocumentoCircularDTO as $objDocumentoCircularDTO){
      ...
      $numDestinatarios = count($arrObjParticipanteDTO);
      ...
      $numEmail = count($arrObjDocumentoDTOEmail);
...
?>
  ...
  <div id="divDestinatarios" class="infraAreaDados">
    ...
    <div id="divOpcoesDestinatarios">
      <img id="imgPesquisarDestinatarios" onclick="objLupaDestinatarios.selecionar(700,500);" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/lupa.gif" alt="Selecionar Contatos para Destinatários" title="Selecionar Contatos para Destinatários" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"/>
