...
<?if ($bolCadastroOk){ ?>
  ...
  window.opener.atualizarBlocos(<?=$objBlocoDTO->getNumIdBloco()?>);
<?}?>
}
...
?>
  <div id="divIdentificacao" class="infraAreaDados" style="height:4em;">
  ...
  <div id="divUnidades" class="infraAreaDados" style="height:15em;">
    ...
    <img id="imgLupaUnidades" onclick="objLupaUnidades.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Selecionar Unidades" title="Selecionar Unidades" class="infraImg" />	
    <img id="imgExcluirUnidades" onclick="objLupaUnidades.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Unidades Selecionadas" title="Remover Unidades Selecionadas" class="infraImg" />
  </div>
