...
?>
#divCadastroEnderecosEletronicos {height:4.5em;<?=$strDisplayCadastroEmail?>}
...
#sbmGravarEmail {position:absolute;left:82%;top:40.5%;}

#divSinEnvioProcesso {position:absolute;left:0%;top:0%;}
#divSinMailPendencia {position:absolute;left:0%;top:10%;}
#divSinArquivamento {position:absolute;left:0%;top:20%;}
#divSinOuvidoria {position:absolute;left:0%;top:30%;}
#divSinProtocolo {position:absolute;left:0%;top:40%;}
...
ContatoINT::montarContatoAssociado(true, $objUnidadeDTO->getNumIdUnidade(), true, $objUnidadeDTO->getStrCodigoSei(), true, $objUnidadeDTO->getStrIdOrigem(), $objUnidadeDTO->getNumIdContato(), $objUnidadeDTO->getStrSigla(), $objUnidadeDTO->getStrDescricao(),true,'frmUnidadeCadastro');
?>
<div id="divCadastroEnderecosEletronicos" class="infraAreaDados">
  ...
  <input type="text" id="txtEmail" name="txtEmail" class="infraText" value="" onkeypress="infraMascaraTexto(this,event,130);" maxlength="130" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />

  <label id="lblDescricaoEmail" for="txtDescricaoEmail" accesskey="" class="infraLabelOpcional">Descrição:</label>
  <input type="text" id="txtDescricaoEmail" name="txtDescricaoEmail" class="infraText" value="" onkeypress="return transportarEmailEnter(event);" maxlength="130" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
...
<div id="divTabelaEnderecosEletronicos" class="infraAreaTabela">
  ...
  <div id="divSinEnvioProcesso" class="infraDivCheckbox">
    ...
    <label id="lblSinEnvioProcesso" for="chkSinEnvioProcesso" accesskey="" class="infraLabelCheckbox">Disponível para envio de processos</label>
  </div>
  ...
  <div id="divSinMailPendencia" class="infraDivCheckbox">
    ...
    <label id="lblSinMailPendencia" for="chkSinMailPendencia" accesskey="" class="infraLabelCheckbox">Enviar e-mail de aviso quando um processo for remetido para a unidade</label>
  </div>
    ...
    <label id="lblSinArquivamento" for="chkSinArquivamento" accesskey="" class="infraLabelCheckbox">Unidade de arquivamento</label>
  </div>
  ...
  <div id="divSinOuvidoria" class="infraDivCheckbox">
    ...
    <label id="lblSinOuvidoria" for="chkSinOuvidoria" accesskey="" class="infraLabelCheckbox">Unidade de ouvidoria</label>
  </div>
  ...
  <div id="divSinProtocolo" class="infraDivCheckbox">
    ...
    <label id="lblSinProtocolo" for="chkSinProtocolo" accesskey="" class="infraLabelCheckbox">Unidade de protocolo</label>
  </div>
