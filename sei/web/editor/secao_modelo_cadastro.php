...
?>
  ...
  <table style="width: 100%">
    ...
    <td style="vertical-align: top;"> <a href="javascript:void(0)" id="ancAjuda" onclick="exibirAjuda();" title="Ajuda" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><img src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/ajuda.gif" class="infraImg"/></a>
    </td>
  </table>
<?
  PaginaSEI::getInstance()->abrirAreaDados('15em');
?>
  ...
  <img id="imgLupaEstilosMultiplaObjeto" onclick="objLupaEstilosMultipla.selecionar(700,500);" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/lupa.gif" alt="Selecionar Estilos" title="Selecionar Estilos" class="infraImgNormal" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />	
  <img id="imgExcluirEstilosMultiplaObjeto" onclick="objLupaEstilosMultipla.remover();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/remover.gif" alt="Remover Estilos" title="Remover Estilos" class="infraImgNormal" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"/>  
