  ...
  if ($numRegistros > 0){
    ...
    */
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=modelo_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_modelo='.$arrObjModeloDTO[$i]->getNumIdModelo()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/consultar.gif" title="Consultar Modelo" alt="Consultar Modelo" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=modelo_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_modelo='.$arrObjModeloDTO[$i]->getNumIdModelo()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/alterar.gif" title="Alterar Modelo" alt="Alterar Modelo" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoSecaoModeloListar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=secao_modelo_listar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_modelo='.$arrObjModeloDTO[$i]->getNumIdModelo()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/valores.gif" title="Seções do Modelo" alt="Seções do Modelo" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoClonar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=modelo_clonar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_modelo_origem='.$arrObjModeloDTO[$i]->getNumIdModelo()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/clonar.gif" title="Clonar Modelo" alt="Clonar Modelo" class="infraImg" /></a>&nbsp;';
      }
