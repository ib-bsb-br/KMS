        ...
        if (count($arrObjAnexoDTO)){
        	...
        	foreach($arrObjAnexoDTO as $objAnexoDTO){
		        ...
		        if ($bolAcaoDownload){
		          ...
		          $arrAcoesDownload[$objAnexoDTO->getNumIdAnexo()] = '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=base_conhecimento_download_anexo&id_anexo='.$objAnexoDTO->getNumIdAnexoOrigem()).'" target="_blank"><img src="imagens/download.gif" title="Baixar Anexo" alt="Baixar Anexo" class="infraImg" /></a> ';
		        }
...
#txtDescricao {position:absolute;left:0%;top:12%;width:49%;}

#lblTipoProcedimento {position:absolute;left:0%;top:32%;width:49%;}
#txtTipoProcedimento {position:absolute;left:0%;top:44%;width:49%;}
...
?>
  <div id="divDados" class="infraAreaDados" style="height:16em;">
  ...
  <img id="imgLupaTipoProcedimento" onclick="objLupaTipoProcedimento.selecionar(700,500);" src="/infra_css/imagens/lupa.gif" alt="Selecionar Tipo de Processo" title="Selecionar Tipo de Processo" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />	
  <img id="imgExcluirTipoProcedimento" onclick="objLupaTipoProcedimento.remover();" src="/infra_css/imagens/remover.gif" alt="Remover Tipos de Processo Selecionados" title="Remover Tipos de Processo Selecionados" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />  
