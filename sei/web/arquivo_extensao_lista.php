...
try {
  ...
  if ($numRegistros > 0){
    ...
    */
    ...
    $strResultado .= '<th class="infraTh" width="15%">'.PaginaSEI::getInstance()->getThOrdenacao($objArquivoExtensaoDTO,'Tamanho Máximo (Mb)','TamanhoMaximo',$arrObjArquivoExtensaoDTO).'</th>'."\n";
