 ...
 */
  ...
  protected function montarIndexacaoControlado(ObservacaoDTO $parObjObservacaoDTO){
    try{
      ...
      $objObservacaoDTO = $this->consultarRN0221($objObservacaoDTO);

      $strIndexacao = InfraString::prepararIndexacao($objObservacaoDTO->getStrDescricao(), false);

      $objObservacaoDTO = new ObservacaoDTO();
      $objObservacaoDTO->setStrIdxObservacao($strIndexacao);
      $objObservacaoDTO->setNumIdObservacao($parObjObservacaoDTO->getNumIdObservacao());

      $objInfraException = new InfraException();
      $this->validarStrIdxObservacao($objObservacaoDTO, $objInfraException);
      $objInfraException->lancarValidacoes();
