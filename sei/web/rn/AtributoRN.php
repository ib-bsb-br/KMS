      ...
      if ($objAtributoDTO->isSetStrStaTipo()){
        if ($objAtributoDTO->getStrStaTipo()!=$objAtributoDTOBanco->getStrStaTipo()) {
          ...
          if ($objAtributoDTO->getStrStaTipo() != AtributoRN::$TA_LISTA &&
            ...
            if ($objAtributoDTO->isSetArrObjDominioDTO() && count($objAtributoDTO->getArrObjDominioDTO())){
              ...
              $objDominioRN = new DominioRN();
              if ($objDominioRN->contarRN0584($objDominioDTO) && (!$objAtributoDTO->isSetArrObjDominioDTO() || count($objAtributoDTO->getArrObjDominioDTO()))) {
