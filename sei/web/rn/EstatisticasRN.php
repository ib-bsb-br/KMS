...
//      $t = InfraUtil::verificarTempoProcessamento();
      ...
      $objEstatisticasAtividadeDTO->retDtaGeracaoProtocolo();
      ...
      $objEstatisticasDTO = null;
        ...
        $dtoBase->setDblQuantidade(null);
				...
				foreach($arrObjEstatisticasAtividadeDTO as $objEstatisticaAtividadeDTO){
					...
					$strMes = substr($objEstatisticaAtividadeDTO->getDtaGeracaoProtocolo(),3,2);
					$strAno = substr($objEstatisticaAtividadeDTO->getDtaGeracaoProtocolo(),6,4);
					$strMesAno = substr($objEstatisticaAtividadeDTO->getDtaGeracaoProtocolo(),3,7);
					$numIdTipoProcedimento = $objEstatisticaAtividadeDTO->getNumIdTipoProcedimentoProcedimento();
					

					//Gerados no período ano
					if (InfraData::compararDatas($parObjEstatisticasDTO->getDtaInicio(),$objEstatisticaAtividadeDTO->getDtaGeracaoProtocolo())>=0 &&
					    InfraData::compararDatas($objEstatisticaAtividadeDTO->getDtaGeracaoProtocolo(),$parObjEstatisticasDTO->getDtaFim())>=0 &&
            ...
            $this->acumular($dto);
				...
				$objEstatisticasDocumentoDTO->retDtaGeracaoProtocolo();
				...
				$objEstatisticasDocumentoDTO->adicionarCriterio(array('GeracaoProtocolo','GeracaoProtocolo'),
				...
				foreach ($arrObjEstatisticasDocumentoDTO as $objEstatisticasDocumentoDTO){
					...
					$strMes = substr($objEstatisticasDocumentoDTO->getDtaGeracaoProtocolo(),3,2);
					$strAno = substr($objEstatisticasDocumentoDTO->getDtaGeracaoProtocolo(),6,4);
    ...
    try{
      ...
      $objInfraException->lancarValidacoes();
        ...
        if (!InfraString::isBolVazia($parObjEstatisticasInspecaoDTO->getNumIdOrgao())){
          $objProtocoloDTO->setNumIdOrgaoUnidadeGeradora($parObjEstatisticasInspecaoDTO->getNumIdOrgao());
        }
        ...
        if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_UNIDADES_GERADOS && !InfraString::isBolVazia($parObjEstatisticasInspecaoDTO->getNumIdUnidade())){
          $objProtocoloDTO->setNumIdUnidadeGeradora($parObjEstatisticasInspecaoDTO->getNumIdUnidade());
        }
        ...
        if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_TIPOS_GERADOS && !InfraString::isBolVazia($parObjEstatisticasInspecaoDTO->getNumIdTipoProcedimento())){
          $objProtocoloDTO->setNumIdTipoProcedimentoProcedimento($parObjEstatisticasInspecaoDTO->getNumIdTipoProcedimento());
        }
        ...
        if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_ORGAOS_GERADOS){
          ...
          $objProtocoloDTO->setOrdStrSiglaOrgaoUnidadeGeradora(InfraDTO::$TIPO_ORDENACAO_ASC);
          $objProtocoloDTO->setOrdStrSiglaUnidadeGeradora(InfraDTO::$TIPO_ORDENACAO_ASC);
        ...
        $arrObjProtocoloDTO = $objProtocoloRN->listarRN0668($objProtocoloDTO);
  			...
  			foreach($arrObjProtocoloDTO as $objProtocoloDTO){
  			  ...
  			  if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_ORGAOS_GERADOS){
    			  if (!isset($arrProcessosGeradosOrgao[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()])){
    				  $arrProcessosGeradosOrgao[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()] = 1;
    				}else{
    					$arrProcessosGeradosOrgao[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()]++;
    				}
  			  }else if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_UNIDADES_GERADOS){
  
    			  if (!isset($arrProcessosGeradosUnidade[$objProtocoloDTO->getNumIdUnidadeGeradora()])){
    				  $arrProcessosGeradosUnidade[$objProtocoloDTO->getNumIdUnidadeGeradora()] = 1;
    				}else{
    					$arrProcessosGeradosUnidade[$objProtocoloDTO->getNumIdUnidadeGeradora()]++;
    				}
  				}else if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_TIPOS_GERADOS){
    			  if (!isset($arrProcessosGeradosTipo[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()][$objProtocoloDTO->getNumIdTipoProcedimentoProcedimento()])){
    				  $arrProcessosGeradosTipo[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()][$objProtocoloDTO->getNumIdTipoProcedimentoProcedimento()] = 1;
    				}else{
    					$arrProcessosGeradosTipo[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()][$objProtocoloDTO->getNumIdTipoProcedimentoProcedimento()]++;
    				}
  				}
  				*/
  				/*
      	  $dto = new EstatisticasDTO(); 
      	  $dto->setDblIdEstatisticas($objEstatisticasInspecaoDTO->getDblIdInspecao());
      	  $dto->setDblIdProcedimento($objProtocoloDTO->getDblIdProtocolo());
      	  $dto->setNumIdTipoProcedimento(....);
      	  $dto->setDblIdDocumento(null);
      	  $dto->setNumIdUnidade($objProtocoloDTO->getNumIdUnidadeGeradora());
      	  $dto->setNumIdUsuario(SessaoSEI::getInstance()->getNumIdUsuario());
      	  $dto->setNumMes(substr($objProtocoloDTO->getDtaGeracao(),3,2));
      	  $dto->setNumAno(substr($objProtocoloDTO->getDtaGeracao(),6,4));
      	  $dto->setDblTempoAberto(null);
        	$dto->setDthAbertura(null);
        	$dto->setDthConclusao(null);
      	  $dto->setDthSnapshot($dthSnapshot);
      	  $dto->setDblQuantidade(null);
      	  $objEstatisticasBD->cadastrar($dto);
      	  */
        ...
        if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_TIPOS_DOCUMENTOS && !InfraString::isBolVazia($parObjEstatisticasInspecaoDTO->getNumIdSerie())){
          $objProtocoloDTO->setNumIdSerieDocumento($parObjEstatisticasInspecaoDTO->getNumIdSerie());
        }
        ...
        $objProtocoloDTO->setOrdStrSiglaOrgaoUnidadeGeradora(InfraDTO::$TIPO_ORDENACAO_ASC);
  		  ...
  		  if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_UNIDADES_DOCUMENTOS){
 			    $objProtocoloDTO->setOrdStrSiglaUnidadeGeradora(InfraDTO::$TIPO_ORDENACAO_ASC);
 					...
 					$objProtocoloDTO->setOrdStrNomeSerieDocumento(InfraDTO::$TIPO_ORDENACAO_ASC);
			  }         
        ...
        $arrObjProtocoloDTO = $objProtocoloRN->listarRN0668($objProtocoloDTO);
  			...
  			foreach($arrObjProtocoloDTO as $objProtocoloDTO){
  			  ...
  			  if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_ORGAOS_DOCUMENTOS){
    			  ...
    			  if (!isset($arrDocumentosOrgao[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()])){
      				$arrDocumentosOrgao[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()][ProtocoloRN::$TP_DOCUMENTO_GERADO] = '';
      				$arrDocumentosOrgao[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()][ProtocoloRN::$TP_DOCUMENTO_RECEBIDO] = '';
    			  }

   			    $arrDocumentosOrgao[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()][$objProtocoloDTO->getStrStaProtocolo()]++;
    			  
  			  }else if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_UNIDADES_DOCUMENTOS){
  			    
    			  if (!isset($arrDocumentosUnidade[$objProtocoloDTO->getNumIdUnidadeGeradora()])){
    			    $arrDocumentosUnidade[$objProtocoloDTO->getNumIdUnidadeGeradora()][ProtocoloRN::$TP_DOCUMENTO_GERADO] = '';
    			    $arrDocumentosUnidade[$objProtocoloDTO->getNumIdUnidadeGeradora()][ProtocoloRN::$TP_DOCUMENTO_RECEBIDO] = '';
    			  }

  			    $arrDocumentosUnidade[$objProtocoloDTO->getNumIdUnidadeGeradora()][$objProtocoloDTO->getStrStaProtocolo()]++;
    			  
  			  }else if ($parObjEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_TIPOS_DOCUMENTOS){
  			    
    			  if (!isset($arrDocumentosTipo[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()][$objProtocoloDTO->getNumIdSerieDocumento()])){
    				  $arrDocumentosTipo[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()][$objProtocoloDTO->getNumIdSerieDocumento()][ProtocoloRN::$TP_DOCUMENTO_GERADO] = '';
    				  $arrDocumentosTipo[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()][$objProtocoloDTO->getNumIdSerieDocumento()][ProtocoloRN::$TP_DOCUMENTO_RECEBIDO] = '';
    				}
    				  
    				$arrDocumentosTipo[$objProtocoloDTO->getNumIdOrgaoUnidadeGeradora()][$objProtocoloDTO->getNumIdSerieDocumento()][$objProtocoloDTO->getStrStaProtocolo()]++;
  			  }
  			  */
  				/*
      	  $dto = new EstatisticasDTO(); 
      	  $dto->setDblIdEstatisticas($objEstatisticasInspecaoDTO->getDblIdInspecao());
      	  $dto->setDblIdProcedimento($objProtocoloDTO->getDblIdProcedimentoDocumento());
      	  $dto->setNumIdTipoProcedimento(....);
        ...
        $arrObjEstatisticasAtividadeDTO = $objEstatisticasBD->listar($objEstatisticasAtividadeDTO);
      	  ...
      	  $dto->setNumIdUnidade($objEstatisticaAtividadeDTO->getNumIdUnidade());
      	  $dto->setNumIdUsuario(SessaoSEI::getInstance()->getNumIdUsuario());
      	  $dto->setNumMes(substr($objEstatisticaAtividadeDTO->getDtaGeracaoProtocolo(),3,2));
      	  $dto->setNumAno(substr($objEstatisticaAtividadeDTO->getDtaGeracaoProtocolo(),6,4));
      	  $dto->setDblTempoAberto(null);
       	  $dto->setDthAbertura(null);
       	  $dto->setDthConclusao(null);
      	  $dto->setDthSnapshot($dthSnapshot);
...
//      $t = InfraUtil::verificarTempoProcessamento();
      ...
      */
	    ...
	    $objEstatisticasAtividadeDTO->adicionarCriterio(array('GeracaoProtocolo','GeracaoProtocolo'),
	                                                    array(InfraDTO::$OPER_MAIOR_IGUAL, InfraDTO::$OPER_MENOR_IGUAL),
