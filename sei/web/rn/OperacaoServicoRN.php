...
class OperacaoServicoRN extends InfraRN {
  ...
  public function listarValoresOperacaoServico(){
    try {
      ...
      $objTipoOperacaoServicoDTO->setStrDescricao('Gerar Procedimento');
      ...
      $objTipoOperacaoServicoDTO->setStrDescricao('Consultar Procedimento');
      ...
      $objTipoOperacaoServicoDTO->setStrDescricao('Consultar Procedimento Individual');
