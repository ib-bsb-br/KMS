...
class GrupoAcompanhamentoRN extends InfraRN {
  ...
  private function validarNumIdUnidade(GrupoAcompanhamentoDTO $objGrupoAcompanhamentoDTO, InfraException $objInfraException){
	...
	private function verificarExistencia(GrupoAcompanhamentoDTO $objGrupoAcompanhamentoDTO, InfraException $objInfraException){
		
		// Verifica se o Grupo existe dentro desta unidade
		$objGrupoAcompanhamentoVerificacaoDTO = new GrupoAcompanhamentoDTO();
		$objGrupoAcompanhamentoVerificacaoDTO->setNumIdUnidade($objGrupoAcompanhamentoDTO->getNumIdUnidade());
		$objGrupoAcompanhamentoVerificacaoDTO->setStrNome($objGrupoAcompanhamentoDTO->getStrNome());
		$objGrupoAcompanhamentoVerificacaoDTO->retNumIdGrupoAcompanhamento();		

    if ($this->consultar($objGrupoAcompanhamentoVerificacaoDTO)){
  ...
  protected function cadastrarControlado(GrupoAcompanhamentoDTO $objGrupoAcompanhamentoDTO) {
    try{
      ...
      $this->verificarExistencia($objGrupoAcompanhamentoDTO, $objInfraException);
  ...
  protected function excluirControlado($arrObjGrupoAcompanhamentoDTO){
    try {
      ...
      if (count($arrObjGrupoAcompanhamentoDTO)){
        ...
        $objAcompanhamentoDTO->setNumIdGrupoAcompanhamento(InfraArray::converterArrInfraDTO($arrObjGrupoAcompanhamentoDTO,'IdGrupoAcompanhamento'),InfraDTO::$OPER_IN);
