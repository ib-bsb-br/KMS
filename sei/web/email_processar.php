  ...
  switch($_GET['acao']){
    ...
    case 'documento_enviar_email':
      ...
      if (isset($_POST['hdnFlagEmail'])){
          ...
          $strItensSelDe = '<option value="' . $strEmailDe . '">' . $strEmailDe . '</option>';
...
#selDe {position:absolute;left:0%;top:45%;width:95.5%;}
...
#txtAssunto {position:absolute;left:0%;top:5%;width:95%;}
...
?>
  <div id="divDe" class="infraAreaDados" style="height:4em;">
  ...
  <p style="margin-top: 0px;">
    ...
    &nbsp;
    <img id="imgSelecionarGrupo" onclick="selecionarGrupo();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/grupo.gif" title="Selecionar Grupos de E-mail" alt="Selecionar Grupos de E-mail" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
  </p>
  ...
  <div id="divCCO" class="infraAreaDados" style="height:2.5em;">
