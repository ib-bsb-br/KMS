    ...
    case 'documento_escolher_tipo':
      ...
      if (SessaoSEI::getInstance()->verificarPermissao('documento_gerar')){
        ...
        if ($strFiltroSerie=='T'){
          ...
          $strImgExibir = '<img id="imgExibirSeries" onclick="exibirSeries(\'U\');" src="/infra_css/imagens/menos.gif" title="Exibir apenas os tipos já utilizados pela unidade" alt="Exibir apenas os tipos já utilizados pela unidade" class="infraImg" />';
        }
      }
