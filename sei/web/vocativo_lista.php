...
try {
  ...
  if ($numRegistros > 0){
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=vocativo_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_vocativo='.$arrObjVocativoDTO[$i]->getNumIdVocativo()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/consultar.gif" title="Consultar Vocativo" alt="Consultar Vocativo" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=vocativo_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_vocativo='.$arrObjVocativoDTO[$i]->getNumIdVocativo()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/alterar.gif" title="Alterar Vocativo" alt="Alterar Vocativo" class="infraImg" /></a>&nbsp;';
      }


      if ($bolAcaoDesativar){
        $strResultado .= '<a href="#ID-'.$arrObjVocativoDTO[$i]->getNumIdVocativo().'"  onclick="acaoDesativar(\''.$arrObjVocativoDTO[$i]->getNumIdVocativo().'\',\''.$arrObjVocativoDTO[$i]->getStrExpressao().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/desativar.gif" title="Desativar Vocativo" alt="Desativar Vocativo" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar){
        $strResultado .= '<a href="#ID-'.$arrObjVocativoDTO[$i]->getNumIdVocativo().'"  onclick="acaoReativar(\''.$arrObjVocativoDTO[$i]->getNumIdVocativo().'\',\''.$arrObjVocativoDTO[$i]->getStrExpressao().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/reativar.gif" title="Reativar Vocativo" alt="Reativar Vocativo" class="infraImg" /></a>&nbsp;';
      }


      if ($bolAcaoExcluir){
        $strResultado .= '<a href="#ID-'.$arrObjVocativoDTO[$i]->getNumIdVocativo().'"  onclick="acaoExcluir(\''.$arrObjVocativoDTO[$i]->getNumIdVocativo().'\',\''.$arrObjVocativoDTO[$i]->getStrExpressao().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/excluir.gif" title="Excluir Vocativo" alt="Excluir Vocativo" class="infraImg" /></a>&nbsp;';
      }
