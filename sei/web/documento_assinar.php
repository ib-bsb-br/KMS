  ...
  switch($_GET['acao']){
    ...
    case 'documento_assinar':
      ...
      if ($_GET['acao_origem']=='bloco_assinatura_listar'){
        ...
        $strLinkRetorno = SessaoSEI::getInstance()->assinarLink('controlador.php?acao='.$_GET['acao_origem'].'&acao_origem='.$_GET['acao'].'&id_bloco='.$_GET['id_bloco'].PaginaSEI::montarAncora($arrIdDocumentoBloco));
