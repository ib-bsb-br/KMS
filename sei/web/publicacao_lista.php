...
//      $arrComandos[] = '<button type="button" accesskey="E" id="btnExcluir" value="Excluir" onclick="acaoExclusaoMultipla();" class="infraButton"><span class="infraTeclaAtalho">E</span>xcluir</button>';
    ...
    foreach($arrObjPublicacaoDTO as $objPublicacaoDTO){
      ...
      $strResultado .= '<td align="center" valign="top">'.PublicacaoINT::montarDadosImprensaNacional($objPublicacaoDTO->getStrSiglaVeiculoImprensaNacional(), $objPublicacaoDTO->getStrDescricaoVeiculoImprensaNacional(), $objPublicacaoDTO->getDtaPublicacaoIO(), $objPublicacaoDTO->getStrNomeSecaoImprensaNacional(), $objPublicacaoDTO->getStrPaginaIO()).'</td>';
