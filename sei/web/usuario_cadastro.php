...
?>
  ...
  <div id="divSinAcessibilidade" class="infraDivCheckbox">
    ...
    &nbsp;&nbsp;
    <a href="javascript:void(0);" id="ancAjuda" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" <?=PaginaSEI::montarTitleTooltip('É necessário que o usuário realize novo login no sistema para que esta alteração tenha efeito.')?>><img src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/ajuda.gif" class="infraImg"/></a>
  </div>
