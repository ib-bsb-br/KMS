...
?>
  ...
  <img id="imgRelProtocoloProtocoloAcima" onclick="objLupaRelProtocoloProtocolo.moverAcima();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/seta_acima_select.gif" alt="Mover Acima Protocolo Selecionado" title="Mover Acima Protocolo Selecionado" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />	
  <img id="imgRelProtocoloProtocoloAbaixo" onclick="objLupaRelProtocoloProtocolo.moverAbaixo();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/seta_abaixo_select.gif" alt="Mover Abaixo Protocolo Selecionado" title="Mover Abaixo Protocolo Selecionado" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />  
