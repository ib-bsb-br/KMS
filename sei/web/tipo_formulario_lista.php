    ...
    */
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoVisualizar && in_array($arrObjTipoFormularioDTO[$i]->getNumIdTipoFormulario(),$arrIdTipoFormularioComAtributos)) {
        $strResultado .= '<a href="#" onclick="infraAbrirJanela(\''.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=tipo_formulario_visualizar&id_tipo_formulario='.$arrObjTipoFormularioDTO[$i]->getNumIdTipoFormulario()).'\',\'janelaTipoFormulario\',700,500,\'location=0,status=1,resizable=1,scrollbars=1\',false)" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensLocal().'/sei_formulario1.gif" title="Visualizar Tipo de Formulário" alt="Visualizar Tipo de Formulário" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAtributoListar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=atributo_listar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_tipo_formulario='.$arrObjTipoFormularioDTO[$i]->getNumIdTipoFormulario()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/valores.gif" title="Campos do Tipo de Formulário" alt="Campos do Tipo de Formulário" class="infraImg" /></a>&nbsp;';
      }

      //if ($bolAcaoConsultar){
      //  $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=tipo_formulario_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_tipo_formulario='.$arrObjTipoFormularioDTO[$i]->getNumIdTipoFormulario()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/consultar.gif" title="Consultar Tipo de Formulário" alt="Consultar Tipo de Formulário" class="infraImg" /></a>&nbsp;';
      //}

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=tipo_formulario_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_tipo_formulario='.$arrObjTipoFormularioDTO[$i]->getNumIdTipoFormulario()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/alterar.gif" title="Alterar Tipo de Formulário" alt="Alterar Tipo de Formulário" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoClonar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=tipo_formulario_clonar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_tipo_formulario_origem='.$arrObjTipoFormularioDTO[$i]->getNumIdTipoFormulario()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensLocal().'/sei_formulario_clonar.gif" title="Clonar Tipo de Formulário" alt="Clonar Tipo de Formulário" class="infraImg" /></a>&nbsp;';
      }
      ...
      if ($bolAcaoDesativar){
        $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/desativar.gif" title="Desativar Tipo de Formulário" alt="Desativar Tipo de Formulário" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar){
        $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/reativar.gif" title="Reativar Tipo de Formulário" alt="Reativar Tipo de Formulário" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoExcluir){
        $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/excluir.gif" title="Excluir Tipo de Formulário" alt="Excluir Tipo de Formulário" class="infraImg" /></a>&nbsp;';
      }
