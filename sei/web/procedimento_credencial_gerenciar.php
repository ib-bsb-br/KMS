...
try {
  ...
  if ($numRegistros > 0){
    ...
    $strResultado .= '<th class="infraTh" width="30%">Concessão</th>'."\n";
    $strResultado .= '<th class="infraTh" width="30%">Cassação</th>'."\n";
...
function acaoCassacaoMultipla(){
  ...
  if (confirm("Confirma cassação das credenciais selecionadas?")){
