...
try {
  ...
  if ($bolInspecaoGeral){
    ...
    $objEstatisticasInspecaoDTO->setNumIdOrgao(SessaoSEI::getInstance()->getNumIdOrgaoUsuario());
  }
  ...
  if ($objEstatisticasInspecaoDTORet!=null){
    ...
    if ($objEstatisticasInspecaoDTO->getStrStaTipo()==EstatisticasRN::$TIPO_INSPECAO_MOVIMENTACAO){
      ...
      $numRegistrosMovimentacao = count($arrObjEstatisticasAtividadeDTO);
...
<form id="frmInspecaoAdministrativa"  method="post" onsubmit="return onSubmitForm();" action="<?=SessaoSEI::getInstance()->assinarLink('controlador.php?acao='.$_GET['acao'].'&acao_origem='.$_GET['acao'])?>">
  ...
  <div id="divPeriodo" class="infraAreaDados" style="height:4.6em;">
    ...
    <input type="text" id="txtPeriodoDe" name="txtPeriodoDe" class="infraText" value="<?=$dtaPeriodoDe?>" onkeypress="return infraMascaraData(this, event)" />
		<img id="imgCalPeriodoD" title="Selecionar Data Inicial" alt="Selecionar Data Inicial" src="/infra_css/imagens/calendario.gif" class="infraImg" onclick="infraCalendario('txtPeriodoDe',this);" />    
    ...
    <img id="imgCalPeriodoA" title="Selecionar Data Final" alt="Selecionar Data Final" src="/infra_css/imagens/calendario.gif" class="infraImg" onclick="infraCalendario('txtPeriodoA',this);" />
