...
#btnPesquisar {position:absolute;left:26%;top:6%;width:10%;}
...
?>
  ...
  <textarea id="txaMotivo" name="txaMotivo" rows="<?=PaginaSEI::getInstance()->isBolNavegadorFirefox()?'5':'6'?>" class="infraTextarea" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><?=PaginaSEI::tratarHTML($objMoverDocumentoDTO->getStrMotivo());?></textarea>
