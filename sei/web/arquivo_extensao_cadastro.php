...
?>
  ...
  <textarea id="txaDescricao" name="txaDescricao" rows="10"  class="infraTextarea" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><?=PaginaSEI::tratarHTML($objArquivoExtensaoDTO->getStrDescricao());?></textarea>
