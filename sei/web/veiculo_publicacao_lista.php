...
try {
  ...
  if ($numRegistros > 0){
    ...
    */
    ...
    $strResultado .= '<th class="infraTh" width="20%">'.PaginaSEI::getInstance()->getThOrdenacao($objVeiculoPublicacaoDTO,'Tipo','StaTipo',$arrObjVeiculoPublicacaoDTO).'</th>'."\n";    
    //$strResultado .= '<th class="infraTh">'.PaginaSEI::getInstance()->getThOrdenacao($objVeiculoPublicacaoDTO,'Fonte de Feriados','SinFonteFeriados',$arrObjVeiculoPublicacaoDTO).'</th>'."\n";
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      //$strResultado .= '<td>'.$arrObjVeiculoPublicacaoDTO[$i]->getStrSinFonteFeriados().'</td>';
