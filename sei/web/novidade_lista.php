 ...
 */    }else{
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoLiberar && $arrObjNovidadeDTO[$i]->getDthLiberacao()==NovidadeRN::$DATA_NAO_LIBERADO){
        $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoLiberar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/marcar.gif" title="Liberar Novidade" alt="Liberar Novidade" class="infraImg" /></a>&nbsp;';
      }
      
      if ($bolAcaoCancelarLiberacao && $arrObjNovidadeDTO[$i]->getDthLiberacao()!=NovidadeRN::$DATA_NAO_LIBERADO){
        $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoCancelarLiberacao(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/remover.gif" title="Cancelar Liberação da Novidade" alt="Cancelar Liberação da Novidade" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=novidade_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_novidade='.$arrObjNovidadeDTO[$i]->getNumIdNovidade()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/consultar.gif" title="Consultar Novidade" alt="Consultar Novidade" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar && $arrObjNovidadeDTO[$i]->getDthLiberacao()==NovidadeRN::$DATA_NAO_LIBERADO){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=novidade_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_novidade='.$arrObjNovidadeDTO[$i]->getNumIdNovidade()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/alterar.gif" title="Alterar Novidade" alt="Alterar Novidade" class="infraImg" /></a>&nbsp;';
      }


      if ($bolAcaoExcluir && $arrObjNovidadeDTO[$i]->getDthLiberacao()==NovidadeRN::$DATA_NAO_LIBERADO){
        $strResultado .= '<a href="'.PaginaSEI::getInstance()->montarAncora($strId).'" onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="'.PaginaSEI::getInstance()->getDiretorioImagensGlobal().'/excluir.gif" title="Excluir Novidade" alt="Excluir Novidade" class="infraImg" /></a>&nbsp;';
      }
