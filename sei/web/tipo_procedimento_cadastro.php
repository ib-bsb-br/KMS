...
#divSinOuvidoria {position:absolute;left:0%;top:0%;}
#divSinIndividual {position:absolute;left:0%;top:20%;}
#divSinInterno {position:absolute;left:0%;top:40%;}


<? if (PaginaSEI::getInstance()->isBolNavegadorFirefox()){ ?>
#divSinSigilosoPermitido {top:20%;}
#divSinRestritoPermitido {top:40%;}
#divSinPublicoPermitido {top:60%;}

#divOptSigilosoSugestao {top:20%;}
#divOptRestritoSugestao {top:40%;}
#divOptPublicoSugestao {top:60%;}
<? }
...
?>
  ...
  <div id="divNivelAcessoPermitido" class="infraAreaDados" style="height:12em;">
  ...
  <div id="divGrauSigilo" class="infraAreaDados" style="height:4.5em;">  
  ...
  <div id="divOpcoes" class="infraAreaDados" style="height:10em;">
    <div id="divSinOuvidoria" class="infraDivCheckbox">
      ...
      <label id="lblSinOuvidoria" for="chkSinOuvidoria" accesskey="" class="infraLabelCheckbox">Exclusivo da ouvidoria</label>
    </div>
    ...
    <div id="divSinIndividual" class="infraDivCheckbox">
      ...
      <label id="lblSinIndividual" for="chkSinIndividual" accesskey="" class="infraLabelCheckbox">Processo único no órgão por usuário interessado</label>
    </div>
